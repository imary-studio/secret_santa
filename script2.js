...
$form.val("holder") // По дефолту выбранная опция
...
var namesArray = [["Max", "Ann"], ["Brad", "Vicky"], ["Alex", "Natalie"], ["Paul"]]

// Имена тех, кому дарить
var presents = ["Max", "Ann", "Brad", "Vicky", "Alex", "Natalie", "Paul"]


var result = [].concat(...namesArray); // Убрал двойной массив

// Вывод каждого имени как опция в html
...
$("#allform").submit(function onClickSubmit () {
  ...
  function noGift (a, b) {
    if (a == b) {
      //alert("Тебе попался ты, перебрось монетку")
      onClickSubmit();
